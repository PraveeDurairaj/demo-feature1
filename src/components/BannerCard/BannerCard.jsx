                ...
                <div className='grid  grid-cols-1 min-h-[300px] sm:grid-cols-2 sm:min-h-[400px]  md:min-h-[450px] lg:min-h-[550px] px-[40px]'>
                    <div className='flex  flex-col gap-4 pb-[20px] pt-[50px] sm:pb-[0px] sm:pt-[0] items-center order-2 sm:justify-center sm:items-start sm:gap-4 sm:order-1'>
                        ...
                        <p data-aos='zoom-out' 
                           ...
                           data-aos-once='true'
                            className='text-[36px] leading-[36px]  sm:text-[45px] font-bold md:text-[50px] md:leading-[50px] lg:leading-[72px] text-[#000000]'>
                            {data?.headingTitle}
                        </p>
                        <p  data-aos='side-left' 
                        className='text-[48px] leading-[48px] sm:text-[80px] md:text-[100px] lg:text-[120px] xl:text-[150px] font-bold md:leading-[100px] lg:leading-[120px] text-[#ffffff]' >{data?.HeadingTitleTwo}</p>
